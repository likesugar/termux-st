    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (scheme != null && !UriScheme.SCHEME_FILE.equals(scheme)) {
            ...
            try {
                ...
                if (urlIntent.getAction() != null && urlIntent.getAction().equals(Intent.ACTION_VIEW)
                    && ("http".equals(scheme2) || "https".equals(scheme2))) {
                    Intent webIntent = new Intent(context, com.termux.app.activities.WebActivity.class);
