...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP',{key: 'OPENBROWSER', display: 'ST'}], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN',{key: 'CLEARCACHE', display: 'cc'}]]"; // Double row
